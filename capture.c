...
$Id: capture_client.c,v 1.9 2003/10/31 20:52:23 joq Exp $
*/
...
void setup_disk_thread (thread_info_t *info) {
    SF_INFO sf_info;
    int short_mask;
...
void run_disk_thread (thread_info_t *info) {
    info->can_capture = 1;
...
void setup_ports (int sources, char *source_names[], thread_info_t *info) {
    unsigned int i;
    size_t in_size;
